...
knn_plot_data %>% ggplot(aes(
  ...
  labs(
    ...
    caption = "Graph 5: Cross Validation and Traing Error for fitting knn, with 
...
```
As seen in the Graph 5 k-Nearest Neighbour with $k=1$ gives with smallest training and cross validation errors. Therefore, we recommend using the model with $k=1$ for this model.

Typically $k=1$ overfits. 
